const Public = () => {
  return (
    <>
      ...
      <p>
        Discover a world of knowledge with courses crafted by industry experts.
        From coding to creative arts, we've got the skills you need to succeed.
      </p>

      <h1>🌐 Connect and Collaborate:</h1>

      <p>
        Join a vibrant community of learners just like you! Network,
        collaborate, and share insights with fellow skill enthusiasts from
        around the globe.
      </p>

      <h1>💡 Your Skills, Your Way:</h1>

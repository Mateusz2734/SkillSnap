...
VALUES
    ($1, $2, $3, $4, $5) RETURNING created_at, report_id, reporting_user_id, reported_offer_id, reason, description, status
`
...
SELECT
    created_at, report_id, reporting_user_id, reported_offer_id, reason, description, status
FROM reports
WHERE
    report_id = $1
`
